...
<body>
	<section class="body">
		<div class="container">
			<div class="botones">
				<div class="area">
					<form  method="POST" name="enviar" action="vistacliente.php">
		            	<input type="text" class="form-control" style='text-transform:uppercase;' id="busqueda" name="busqueda" placeholder="Ingrese Para Buscar" >
						<button id="buscar-cliente" name="buscar-cliente" type="submit" class="btn btn-success">Buscar</button>
		    		</form>
		    	</div>
		    	<div class="area">
					<button type="button"
				...
				<table class="table table-striped table-bordered">
						...
						<tbody>
							...
							if (isset($_POST["buscar-cliente"]) ) { 
						        $like = $_POST['busqueda'];
						        $result = $mysqli->query("SELECT * FROM cliente WHERE nombre LIKE '%".$like."%'");
						      	if( !$result )
									die( $mysqli->error );
							}
							/////////////////Area De Rellenado De Tabla////////////////////////////////
